...
class MyAttention(nn.Module):
    ...
    def forward(self, x, x_source, loc_source, H, W):
        B, N, C = x.shape
...
@register_model
def mypvt7_small(pretrained=False, **kwargs):
    model = MyPVT7(
...
if __name__ == '__main__':
    ...
    model = mypvt7_small(drop_path_rate=0.1).to(device)
