...
def get_args_parser():
    ...
    parser.add_argument('--fine_factor', type=float, default=0.1)
...
def main(args):
    ...
    if args.finetune:
        ...
        if checkpoint is not None:
            ...
            missing_keys = model_without_ddp.load_state_dict(check_model, strict=False).missing_keys
