...
@register_model
def mypvt3h2_density0_norm_small(pretrained=False, **kwargs):
    model = MyPVT(
...
@register_model
def mypvt3h2_density25_norm_small(pretrained=False, **kwargs):
    model = MyPVT(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1],
...
@register_model
def mypvt3h2_density50_norm_small(pretrained=False, **kwargs):
    model = MyPVT(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1],
...
if __name__ == '__main__':
    ...
    model = mypvt3h2_density0_norm_small(drop_path_rate=0.).to(device)
    import time
