...
from utils_mine import (
    ...
    show_tokens, show_conf, merge_tokens_conv
)
...
class DownLayer(nn.Module):
    ...
    def forward(self, x, pos, H, W, N_grid):
        ...
        x_down, pos_down, x = merge_tokens_conv(x, pos, pos_down, weight, self.conv.weight, self.conv.bias)
...
@register_model
def mypvt3f10_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt3f10_small(drop_path_rate=0.).to(device)
