    ...
    def forward(self, x, pos_orig, idx_agg, agg_weight, H, W, N_grid, grid_merge=False):
        ...
        if grid_merge:
            ...
            x_down, idx_agg_down, weight_t = token_cluster_density(
                x_old, sample_num, idx_agg, weight, True, conf,
...
@register_model
def mypvt3h2_density0fl2_small(pretrained=False, **kwargs):
    model = MyPVT(
...
@register_model
def mypvt3h2_density0fl2_large(pretrained=False, **kwargs):
    model = MyPVT(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def mypvt3h2_density0fl2_tiny(pretrained=False, **kwargs):
    model = MyPVT(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
