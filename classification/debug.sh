...
srun -p pat_earth  --job-name=pvt --ntasks=1 --gres=gpu:1 --ntasks-per-node=1 --cpus-per-task=1 --kill-on-bad-exit=1 python transfer_checkpoint.py
...
srun -p pat_earth -x SH-IDC1-10-198-4-[100-103,116-119] \
    ...
    python -u train.py --config configs/pvt_v2/debug.py \
    --batch-size 64 --data-path data/imagenet --input-size 224 --use-mcloader \
    --model=tcformer_partpad_light --output_dir=work_dirs/debug --resume work_dirs/my3h2_density0f_tiny_16/checkpoint_tcformer.pth --eval
    ...
    --model=tcformer_part_small --output_dir=work_dirs/debug --resume work_dirs/my3h2_density0/checkpoint_tcformer.pth --eval
...
srun -p pat_earth -x SH-IDC1-10-198-4-[100-103,116-119] \
    ...
    python -u train.py --config configs/pvt_v2/debug.py \
    --batch-size 64 --data-path data/imagenet --input-size 224 --use-mcloader \
    --model=hrtcformer_w32 --output_dir=work_dirs/224/hrtc_32 --resume work_dirs/224/hrtc_32/checkpoint.pth


    --model=tcformer_part_small --output_dir=work_dirs/224/tc_part --resume work_dirs/224/tc_part/checkpoint.pth
...
srun -p pat_earth -x SH-IDC1-10-198-4-[90,100-103,116-119] \
    ...
    --model=tcformer_part_small --output_dir=work_dirs/128/tc_part --resume work_dirs/128/tc_part/checkpoint.pth
