...
class DownLayer(nn.Module):
    ...
    def forward(self, x, pos, pos_orig, idx_agg, H, W, N_grid):
        ...
        x_down, pos_down, idx_agg_down = merge_tokens_agg(x, pos, pos_down, idx_agg, weight)
...
@register_model
def mypvt3f11m_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt3f11m_small(drop_path_rate=0.).to(device)
