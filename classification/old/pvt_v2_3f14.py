...
from utils_mine import (
    get_grid_loc,
    gumble_top_k,
    show_tokens_merge, show_conf_merge, merge_tokens_agg_dist, token2map_agg_sparse, map2token_agg_mat
)
...
N_grid = 0,
merge tokens according to feature distance
'''
...
@register_model
def mypvt3f14_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt3f14_small(drop_path_rate=0.).to(device)
