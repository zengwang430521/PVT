...
from utils_mine import get_loc as get_loc

vis = False
# vis = True

'''
do not select tokens, merge tokens. conf.clamp(-7, 7), old get loc
'''
...
@register_model
def mypvt3f5_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt3f5_small(drop_path_rate=0.).to(device)
