...
class MyPVT(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.re_layer = Mlp_old(in_features=embed_dims[0] + embed_dims[1], out_features=embed_dims[1])
...
@register_model
def mypvt6a_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt6a_small(drop_path_rate=0.).to(device)
