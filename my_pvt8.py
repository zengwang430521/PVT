...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        self.patch_embed2 = GridDown(img_size=img_size // 4, patch_size=2, in_chans=embed_dims[0],
                                       embed_dim=embed_dims[1])
        self.patch_embed3 = GridDown(img_size=img_size // 8, patch_size=2, in_chans=embed_dims[1],
                                       embed_dim=embed_dims[2])
        self.patch_embed4 = GridDown(img_size=img_size // 16, patch_size=2, in_chans=embed_dims[2],
...
@register_model
def mypvt8_small(pretrained=False, **kwargs):
...
if __name__ == '__main__':
    ...
    model = mypvt8_small(drop_path_rate=0.1).to(device)
