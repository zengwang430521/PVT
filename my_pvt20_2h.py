...
from pvt_impr8 import (Block, DropPath, to_2tuple, trunc_normal_,register_model, _cfg)
...
'''No SR'''
@register_model
def mypvt20_2g_small(pretrained=False, **kwargs):
    model = MyPVT(
...
if __name__ == '__main__':
    ...
    model = mypvt20_2g_small(drop_path_rate=0.1).to(device)
