spring.submit arun \
    ...
    --finetune work_dirs/my20_s2/my20_300_pre.pth --cache_mode --use-mcloader"
...
srun -p pat_earth -x SH-IDC1-10-198-4-[100-103,116-119] \
    ...
    python -u train.py --model mypvt2520_11_2_small --batch-size 64 --epochs 300 --num_workers 5 \
    --output_dir work_dirs/my2520_11_2 --data-path data/imagenet \
    --input-size 448 \
    --resume work_dirs/my2520_11_2/checkpoint.pth --use-mcloader

    python -u train_finetune.py --model mypvt2520_10_small --batch-size 64 --epochs 30 --num_workers 5 \
    --output_dir work_dirs/debug --data-path data/imagenet \
    --input-size 448 --finetune work_dirs/my20_s2/my20_300_pre.pth --eval --use-mcloader--use-mcloader

    python -u train_finetune.py --model mypvt2520_8_small --batch-size 64 --epochs 30 --num_workers 5 \
    --output_dir work_dirs/debug --data-path data/imagenet \
    --input-size 448 --finetune work_dirs/my20_s2/my20_300_pre.pth --eval --use-mcloader

    python -u train_finetune.py --model mypvt2520_8_small --batch-size 64 --epochs 30 --num_workers 5 \
    --output_dir work_dirs/my2520_8_f --data-path data/imagenet \
    --input-size 448 --resume work_dirs/my2520_8_f/checkpoint.pth \
    --warmup-epochs 1 --cooldown-epochs 2 --fine_factor=0.1 --lr=5e-5 \
    --finetune work_dirs/my20_s2/my20_300_pre.pth --use-mcloader

    python -u train_finetune.py --model mypvt2520_9_small --batch-size 64 --epochs 30 --num_workers 5 \
    --output_dir work_dirs/my2520_9_f --data-path data/imagenet \
    --input-size 448 --resume work_dirs/my2520_9_f/checkpoint.pth \
    --warmup-epochs 1 --cooldown-epochs 2 --fine_factor=0.1 --lr=5e-5 \
    --finetune work_dirs/my20_s2/my20_300_pre.pth --use-mcloader

    python -u train_finetune.py --model mypvt2520_7_small --batch-size 64 --epochs 30 --num_workers 5 \
    --output_dir work_dirs/my2520_7_f --data-path data/imagenet \
    --input-size 448 --resume work_dirs/my2520_7_f/checkpoint.pth \
    --warmup-epochs 1 --cooldown-epochs 2 --fine_factor=0.1 --lr=5e-5 \
    --finetune work_dirs/my20_s2/my20_300_pre.pth --use-mcloader
    ...
    --output_dir work_dirs/my20_2_f2 --data-path data/imagenet \
    --input-size 224 --resume work_dirs/my20_2_f2/checkpoint.pth \
    --resume work_dirs/my20_s2/checkpoint.pth --cache_mode

    python -u train.py --model mypvt20_2_small --batch-size 64 --epochs 330 --num_workers 5 \
